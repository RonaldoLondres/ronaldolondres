...
function comparalistas(letra){
    ...
    if(vitoria == true)
    {
        abreModal("PARABÉNS!", "Você venceu... O nosso jogo da forca. (Ceep Dr.Ruy)");
        tentativas = 0;
        piscarBotaoJogarNovamente(true);
    }
}
...
function carregaListaAutomatica(){
    palavras = [
        palavra001 = {
            nome: "ZIGOTO",
            categoria:"Qual é o tipo de célula que resulta da fusão dos gametas masculino e feminino?"
        },
        palavra002 = {
            nome: "MEIOSE",
            categoria:"Qual é a divisão celular que reduz o número de cromossomos pela metade, ocorrendo nas células germinativas?"
        },
        palavra003 = {
            nome: "ESPERMATOZOIDE",
            categoria:"Como se chama a célula reprodutiva masculina em animais?"
        },
        palavra004 = {
            nome: "BROTAMENTO",
            categoria:"Qual é o nome do processo assexuada em que um novo organismo se desenvolve a partir de um broto?"
        },
        palavra005 = {
            nome: "NAO",
